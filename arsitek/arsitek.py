...
# --- Kontrol Interaktif (Sidebar untuk kerapihan atau di kolom utama) ---
...
# --- Panduan Penemuan dan Pertanyaan ---
...
2.  **Identifikasi Pola:**
    * Lihat data yang kamu kumpulkan di tabel. Apakah kamu melihat hubungan antara Tinggi, Sudut, dan Bayangan?
